...
import { LogOut, Copy, CheckCircle2, Truck, Calculator, ClipboardList, X } from 'lucide-react';
                                ...
                                {historyItems.map(item => (
                                    <div key={item.id} className="relative group">
                                        <button onClick={() => handleLoadEstimate(item.id)}
                                            className="text-left bg-gray-50 hover:bg-blue-50 border border-gray-100 hover:border-blue-200 rounded-xl px-3 py-2.5 transition-all min-w-[160px] max-w-[220px]">
                                            ...
                                            <div className="flex items-center gap-1.5 mt-1 text-[9px] font-semibold text-gray-500">
                                                <span className="font-bold text-gray-700">{item.net_volume || item.final_volume} cf</span>
