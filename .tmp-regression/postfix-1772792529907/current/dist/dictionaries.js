...
exports.SIZE_UNIT_PATTERNS = exports.DA_SIMPLE = exports.DA_COMPLEX = exports.VAGUE_SIGNALS = exports.IRREGULAR_SIGNALS = exports.NUMBERS_REGEX_CACHE = exports.NUMBER_MAP = exports.FRAGILE_REGEX_CACHE = exports.DA_REGEX_CACHE = exports.BLANKET_REGEX_CACHE = exports.KEY_REGEX = exports.SORTED_KEYS = exports.DA_KEYS = exports.BLANKET_KEYS = exports.reEscape = exports.ALIAS_RULES = exports.INVERSIONS = exports.ABBREVIATIONS = exports.STRICT_NO_BLANKET_ITEMS = exports.VOLUME_TABLE = exports.LEAGUE_2_ITEMS = exports.LEAGUE_1_ITEMS = exports.LIFT_GATE_ITEMS = exports.BULKY_ITEMS = exports.TRUE_HEAVY_ITEMS = exports.FRAGILE_KEYWORDS = exports.EFFORT_MULTIPLIER = exports.DA_TIME_TABLE = exports.BLANKETS_TABLE = void 0;
exports.buildKeyRegex = buildKeyRegex;
require("server-only");
exports.BLANKETS_TABLE = {
...
exports.FRAGILE_KEYWORDS = ["mirror", "glass", "china", "lamp", "tv", "artwork", "picture", "wine", "vase", "crystal", "antique", "statue", "marble", "stone", "arcade", "pinball", "clock", "plant", "wine fridge", "wine cooler", "gaming console", "ps5", "xbox setup", "large pet enclosure", "hamster cage", "terrarium"];
// Items that REGULARLY require heavy lifting — trigger HEAVY badge
exports.TRUE_HEAVY_ITEMS = [
...
exports.LIFT_GATE_ITEMS = [...exports.TRUE_HEAVY_ITEMS, ...exports.BULKY_ITEMS];
exports.LEAGUE_1_ITEMS = [
...
exports.BLANKET_KEYS = Object.keys(exports.BLANKETS_TABLE).sort((a, b) => b.length - a.length);
exports.DA_KEYS = Object.keys(exports.DA_TIME_TABLE).sort((a, b) => b.length - a.length);
exports.SORTED_KEYS = Object.keys(exports.VOLUME_TABLE).sort((a, b) => b.length - a.length);
function buildKeyRegex(key) {
    ...
    let lastRe = "";
    if (last.endsWith("s"))
        lastRe = (0, exports.reEscape)(last);
    else
        lastRe = `${(0, exports.reEscape)(last)}(?:s|es)?`;
    const full = head ? `${(0, exports.reEscape)(head)}\\s+${lastRe}` : lastRe;
    return new RegExp(`\\b${full}\\b`, "i");
}
exports.KEY_REGEX = Object.fromEntries(exports.SORTED_KEYS.map((k) => [k, buildKeyRegex(k)]));
exports.BLANKET_REGEX_CACHE = Object.fromEntries(exports.BLANKET_KEYS.map(k => [k, buildKeyRegex(k)]));
exports.DA_REGEX_CACHE = Object.fromEntries(exports.DA_KEYS.map(k => [k, buildKeyRegex(k)]));
exports.FRAGILE_REGEX_CACHE = exports.FRAGILE_KEYWORDS.map(k => new RegExp(`\\b${(0, exports.reEscape)(k)}\\b`, "i"));
exports.NUMBER_MAP = {
...
exports.NUMBERS_REGEX_CACHE = Object.keys(exports.NUMBER_MAP).map(key => ({
    re: new RegExp(`\\b${key}\\b`, "gi"),
    val: exports.NUMBER_MAP[key]
}));
exports.IRREGULAR_SIGNALS = [
...
exports.VAGUE_SIGNALS = ["misc", "miscellaneous", "some boxes", "garage stuff", "storage stuff", "tools", "seasonal", "attic", "shed", "stuff"];
exports.DA_COMPLEX = ["bed", "bunk", "crib", "sectional", "gym", "treadmill", "elliptical", "peloton", "armoire", "wardrobe", "sleeper", "sofa bed", "pool table", "arcade", "trampoline", "adjustable"];
exports.DA_SIMPLE = ["table", "desk", "crib"];
exports.SIZE_UNIT_PATTERNS = [
