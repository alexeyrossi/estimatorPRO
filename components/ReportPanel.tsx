...
import {
    Truck, Box, List, Weight, Terminal, ChevronRight, Lock, Scale, PackageOpen, Clock, CalendarDays, Info, Users, AlertTriangle, ArrowUpFromLine, Check, Clipboard, Loader2, SlidersHorizontal
} from 'lucide-react';
...
interface ReportPanelProps {
    ...
    openReportSection: "inventory" | "details" | null;
    setOpenReportSection: (section: "inventory" | "details" | null) => void;
    handleCopy: () => void;
...
export const ReportPanel = ({
    ...
    const toggleReportSection = (section: "inventory" | "details") => {
        setOpenReportSection(openReportSection === section ? null : section);
    };
            ...
            <GlassPanel><div className="p-7 flex flex-col">
                ...
                <div data-no-pdf className="flex flex-col mt-2">
                    ...
                    <div className="-mx-2 flex w-[calc(100%+1rem)] min-w-0 items-center gap-1 pt-4 md:mx-0 md:w-full md:gap-3">
                        ...
                        <div className="ml-auto flex min-w-0 shrink-0 items-center justify-end gap-0.5 md:gap-2">
                            <button
                                onClick={() => toggleReportSection("inventory")}
                                aria-label="Toggle inventory"
                                title="Inventory"
                                className={`group flex h-[42px] w-auto items-center justify-center gap-1 md:gap-2 rounded-xl px-1.5 md:px-4 py-0 md:py-3 text-[10px] md:text-[14px] font-bold uppercase active:scale-[1.02] ${openReportSection === "inventory" ? "bg-gray-100 text-gray-900" : "text-gray-500 hover:text-gray-900 hover:bg-gray-100"}`}
                            ...
                            <button
                                onClick={() => toggleReportSection("details")}
                                aria-label="Toggle details"
                                title="Details"
                                className={`group flex h-[42px] w-auto items-center justify-center gap-1 md:gap-2 rounded-xl px-1.5 md:px-4 py-0 md:py-3 text-[10px] md:text-[14px] font-bold uppercase active:scale-[1.02] ${openReportSection === "details" ? "bg-gray-100 text-gray-900" : "text-gray-500 hover:text-gray-900 hover:bg-gray-100"}`}
                                style={softActionButtonTransition}
                            >
                ...
                <div className={`grid transition-all duration-500 ease-in-out ${openReportSection ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}>
                    <div className="overflow-hidden">
                        <div className="pt-8 mt-4 border-t border-gray-100">
                            {openReportSection === "inventory" ? (
                                <div className="space-y-4">
                                    ...
                                    {detectedItemCount > 0 ? (
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-h-[22rem] overflow-y-auto pr-1 md:pr-2 pb-2">
                                        ...
                                        <div className="flex min-h-[220px] flex-col items-center justify-center rounded-[1.5rem] border border-dashed border-gray-200 bg-gray-50/70 px-6 text-center">
